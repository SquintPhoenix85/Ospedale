...
public class DoctorDashboardView extends javax.swing.JFrame {
    ...
    private User user;
    public DoctorDashboardView(User user, ArrayList<User>users,ArrayList<Hospitalization> hospitalizations, ArrayList<Appointment> appointments) {
        initComponents();
        this.user = user;
        this.users = users;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        AdminDashboardView doctor = new AdminDashboardView(user,temp, users, hospitalizations,appointments);
